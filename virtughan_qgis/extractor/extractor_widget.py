...
def _resolve_extractor_search_stac_api():
    global extractor_search_stac_api
    ...
    def _use_layer_aoi(self):
        ...
        if len(specs) > 1:
            ...
            mode = choose_multi_polygon_mode(
                self,
                action_label="download images for this AOI",
            ...
            if mode == "combined":
                if len(combined_specs) == 1:
                    ...
                    self._update_aoi_preview(f"Combined AOI: {len(combined_specs)} polygon features.")
                    return
            else:
    ...
    def _run_clicked(self):
        ...
        try:
            ...
            QMessageBox.warning(
                self,
                "VirtuGhan",
                "Pre-download stage timed out after 2 minutes before download started.\n\n"
        ...
        self._has_successful_run = False
        self._last_output_layer_ids = []
        _log(self, "Download handoff: starting backend task.")
